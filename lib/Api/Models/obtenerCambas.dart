...
CambasModel cambasModelFromJson(String str) => CambasModel.fromJson(json.decode(str));
...
class Cambas {
    ...
    factory Cambas.fromJson(Map<String, dynamic> json) => Cambas(
        ...
        original: json["original"] == null ? null : List<Original>.from(json["original"].map((x) => Original.fromJson(x))),
...
class Original {
    ...
    factory Original.fromJson(Map<String, dynamic> json) => Original(
        ...
        precioEstimado: json["precio_estimado"] == null ? null : json["precio_estimado"],
        ...
        estadoPropuesta: json["estado_propuesta"] == null ? null : json["estado_propuesta"],
        categorias: json["categorias"] == null ? null : List<Categoria>.from(json["categorias"].map((x) => Categoria.fromJson(x))),
        imagenes: json["imagenes"] == null ? null : List<Imagene>.from(json["imagenes"].map((x) => Imagene.fromJson(x))),
...
class Categoria {
    ...
    factory Categoria.fromJson(Map<String, dynamic> json) => Categoria(
        id: json["id"] == null ? null : json["id"],
        nombreCategoria: json["nombre_categoria"] == null ? null : json["nombre_categoria"],
        pathImg: json["path_img"] == null ? null : json["path_img"],
        estadoCategoria: json["estado_categoria"] == null ? null : estadoCategoriaValues.map[json["estado_categoria"]],
        padreId: json["padre_id"] == null ? null : json["padre_id"],
        principal: json["principal"] == null ? null : principalValues.map[json["principal"]],
...
final estadoCategoriaValues = EnumValues({
    "Activo": EstadoCategoria.ACTIVO
});
...
class Pivot {
    ...
    factory Pivot.fromJson(Map<String, dynamic> json) => Pivot(
        cambaPropuestaId: json["camba_propuesta_id"] == null ? null : json["camba_propuesta_id"],
        categoriaId: json["categoria_id"] == null ? null : json["categoria_id"],
    );

    Map<String, dynamic> toJson() => {
        "camba_propuesta_id": cambaPropuestaId == null ? null : cambaPropuestaId,
...
final principalValues = EnumValues({
    "No": Principal.NO,
    "Si": Principal.SI
});
...
class Imagene {
    ...
    factory Imagene.fromJson(Map<String, dynamic> json) => Imagene(
        id: json["id"] == null ? null : json["id"],
        cambaPropuestaId: json["camba_propuesta_id"] == null ? null : json["camba_propuesta_id"],
        pathImagen1920: json["path_imagen_1920"] == null ? null : json["path_imagen_1920"],
        createdAt: json["created_at"] == null ? null : DateTime.parse(json["created_at"]),
        updatedAt: json["updated_at"] == null ? null : DateTime.parse(json["updated_at"]),
        pathImagen1280: json["path_imagen_1280"] == null ? null : json["path_imagen_1280"],
        pathImagen640: json["path_imagen_640"] == null ? null : json["path_imagen_640"],
    );
...
class Usuario {
    ...
    factory Usuario.fromJson(Map<String, dynamic> json) => Usuario(
        ...
        tokenValidacion: json["token_validacion"] == null ? null : json["token_validacion"],
...
class EnumValues<T> {
    ...
    @required Map<T, String> ?reverseMap;
